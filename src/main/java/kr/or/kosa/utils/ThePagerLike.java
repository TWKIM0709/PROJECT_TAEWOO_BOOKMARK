...
public class ThePagerLike {
	 ...
	 public ThePagerLike(int dataCount, int currentPage, 
	 ...
	 public String toString(){
	  ...
	  for (int i = start; i < end; i++) {
	   ...
	   linkString.append("&nbsp;");
	   if(i == currentPage) {
	    linkString.append(String.format("<strong>%d</strong>", i));
	   } else { 
	    linkString.append(String.format(
//	     "<a href='%s?cp=%d'>%d</a>", linkUrl, i, i));
	     "<a href='javascript:likeSearch(\"%s\",\"%d\")'>%d</a>",linkUrl,i, i));
	   }
	   linkString.append("&nbsp;");
	  }

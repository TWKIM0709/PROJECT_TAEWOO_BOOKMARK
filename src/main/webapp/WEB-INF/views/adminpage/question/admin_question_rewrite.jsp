...
<body>
	...
	<h1>re:${requestScope.question_title}</h1>
	<form action="questionRewriteOk.do" method="post">
	<input type="hidden" value="${requestScope.question_no }" name="question_no">
		<div>

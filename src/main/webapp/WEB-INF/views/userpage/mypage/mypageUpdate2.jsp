...
<head>
    ...
    <script src="https://connect.facebook.net/en_US/sdk.js?hash=1df673f445afaffeb5a7a5e13fea8398" async=""
    ...
    <script charset="utf-8" src="https://d3udu241ivsax2.cloudfront.net/v3/js/home~payment.7cc59588f2347d06c964.js">
    </script>
    <link rel="stylesheet" type="text/css"
        href="https://d3udu241ivsax2.cloudfront.net/v3/style/home.aadb17a03cc4dec7eb90.css">
    <script charset="utf-8" src="https://d3udu241ivsax2.cloudfront.net/v3/js/home.ed5f655aabea45e2b6cd.js"></script>
    ...
    <script charset="utf-8" src="https://d3udu241ivsax2.cloudfront.net/v3/js/reading~search.30140e35c71695a23426.js">
    </script>
    <link rel="stylesheet" type="text/css"
        href="https://d3udu241ivsax2.cloudfront.net/v3/style/search.d5e7ba02987a9fbca3c2.css">
    <script charset="utf-8" src="https://d3udu241ivsax2.cloudfront.net/v3/js/search.68343292a1c4e3613023.js"></script>
    <link rel="stylesheet" type="text/css"
    ...
    <script charset="utf-8" src="https://d3udu241ivsax2.cloudfront.net/v3/js/bookDetail.99be822072640d1e4f68.js">
    </script>
    <link rel="stylesheet" type="text/css"
        href="https://d3udu241ivsax2.cloudfront.net/v3/style/audioDetail.49dfc892f0cef369883f.css">
    <script charset="utf-8" src="https://d3udu241ivsax2.cloudfront.net/v3/js/audioDetail.c3eab3433e02cfa3dfc1.js">
    </script>
    <script charset="utf-8" src="https://d3udu241ivsax2.cloudfront.net/v3/js/3.0f4883b62b6134b1d0e8.js"></script>
    <link rel="stylesheet" type="text/css"
    ...
    <script charset="utf-8" src="https://d3udu241ivsax2.cloudfront.net/v3/js/management.290a60841f92b77fd5e6.js">
    </script>
...
<jsp:include page="/WEB-INF/views/utils/include/top.jsp"></jsp:include>
    ...
    <script src="https://d3udu241ivsax2.cloudfront.net/v3/js/millie.ab0f5e183b3939fad409.js"></script>
    ...
    <script class="sdk-firebase-app" src="https://www.gstatic.com/firebasejs/6.2.0/firebase-app.js"></script>
    <script class="sdk-firebase-auth" src="https://www.gstatic.com/firebasejs/6.2.0/firebase-auth.js"></script>
    <script class="sdk-firebase-firestore" src="https://www.gstatic.com/firebasejs/6.2.0/firebase-firestore.js">
    </script>
